...
<article id="post-<?php echo $td_mod_single->post->ID;?>" class="<?php echo join(' ', get_post_class('td-post-template-7'));?> td-container-wrap<?php echo $featured_class;?>" <?php echo $td_mod_single->get_item_scope();?>>
...
<?php if (!empty($td_post_featured_image)) {?>
                    ...
                    ?>
                        <div class="td-pb-span8 td-main-content" role="main">
                            <div class="td-ss-main-content">
                                <?php
                                locate_template('celebrity-single-7.php', true);
